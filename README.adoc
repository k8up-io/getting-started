...
NOTE: If you prefer to use https://github.com/kubernetes/minikube[Minikube] instead of k3s, just switch to the https://github.com/vshn/k8up-tutorial/[master branch] in the tutorial repository. There's also a version for https://github.com/vshn/k8up-tutorial/tree/openshift[Red Hat OpenShift]!
